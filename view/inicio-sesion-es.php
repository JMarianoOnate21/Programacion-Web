      ...
      <div class="d-flex align-items-center">
        ...
        <div class="flex-shrink-0 dropdown">
          ...
          <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
            ...
            <li><a class="dropdown-item" href="<?php echo 'perfil-es.php?user='.$user1; ?>">Perfil</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" id="cerrar" href="../es/index.html">Cerrar sesion</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid pb-3" >
    <div class="d-grid gap-3" style="grid-template-columns: 1fr 2fr;">
      <div class="bg-light border rounded-3 ava">
        ...
        <!--cursos-->
        <h2 style="text-align: center; margin-top: 25px; margin-bottom: 25px;">Cursos</h2>
              ...
              <div class="accordion-body">
                ...
                <div class="card" style="width: 34rem;">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">Competencias: Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    consequat.</p>
                    <a href="#" class="btn btn-primary" id="miBoton">Inscribete</a>
                  </div>
                </div>
              ...
              <div class="accordion-body">
                ...
                <div class="card" style="width: 34rem;">
                  ...
                  <div class="card-body">
                    ...
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    consequat.</p>
                    <a href="#" class="btn btn-primary" id="miBoton2">Inscribete</a>
                  </div>
                </div>
              ...
              <div class="accordion-body">
                ...
                <div class="card" style="width: 34rem;">
                  ...
                  <div class="card-body">
                    ...
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    consequat.</p>
                    <a href="#" class="btn btn-primary" id="miBoton3">Inscribete</a>
                  </div>
                </div>
      ...
      <div class="bg-light border rounded-3">
        <h2 style="text-align: center; margin-top: 25px;">Congresos</h2>  
         <?php 
