...
<body style="background: url(../img/topicos.jpg) no-repeat center center/cover;">
	...
	<div style="background: #100f1a; color: white; margin: 45px; padding: 50px 100px;">
		...
		<form method="post">
		  <div class="campo row">
		    ...
		    <div class="col">
		      ...
		      <input type="password" class="form-control"  placeholder="Contraseña" name="p" value="<?php echo $p; ?>">
		    </div>
		  </div><br>
		...
		<div class="campo row">
		   ...
		   <div class="col">
		      <label>Usuario</label>
		      <input type="text" class="form-control" placeholder="Nombre de usuario" name="u" value="<?php echo $u; ?>">
		    </div>

		    <div class="form-group col-md-2">
		      <label for="inputZip">Telefono</label>
		      <input type="text" class="form-control" placeholder="telefono: ej 444" name="t" value="<?php echo $t; ?>">
		    </div>
		</div><br>
		  ...
		  <div class="campo row">
		  	<div class="col">
			    ...
			    <input type="text" class="form-control" placeholder="Nombre" name="n" value="<?php echo $n; ?>">
			</div>
			<div class="col">
			    <label >Apellidos</label>
			    <input type="text" class="form-control" placeholder="Apellido" name="a" value="<?php echo $a; ?>">
			</div>
		  </div><br>
		    ...
		    <div style="text-align: center;">
		    	<button type="submit" class="btn" name="actualizar">Actualizar</button>
		  		<a href="<?php echo 'inicio-sesion-es.php?user='.$correo; ?>" class="btn">Regresar</a>
		    </div>
		</form>
	...
	<?php if(isset($_POST['actualizar'])){
		...
		echo "<script>alert('Se ha actualizado correctamente!'); location='perfil-es.php?user=$e1'</script>";
	} ?>
